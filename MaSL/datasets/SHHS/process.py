...
if __name__ == "__main__":
    ...
    if not os.path.exists("/mnt/replace_disk/EEG_data/shhs/new_processed/"):
        os.makedirs("/mnt/replace_disk/EEG_data/shhs/new_processed/")

    root_folder = "/mnt/replace_disk/EEG_data/shhs/"
